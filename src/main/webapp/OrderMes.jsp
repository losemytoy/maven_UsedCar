...
<%
    List<Order> order = new OrderDao().getALLorder();
    if(order == null){
        order = new ArrayList<>();
    }
%>
...
<form action="searchOrderhello.action" style="text-align: center;margin-top: 50px">
        ...
        <td valign="top" align="center" border="">
            ...
            <table width="100%" border="" cellpadding="1" cellspacing="1" bgcolor="#FECE62">
                ...
                <tr bgcolor="#FFFFFF" align="center">
                    ...
                    <td align="center">
                        <a href="gotoupdataOrderhello?orderNo=<%=order1.getOrderNo()%>">修改</a>&nbsp;&nbsp;
                        <a href="deleteOrderhello?orderNo=<%=order1.getOrderNo()%>">删除</a>
                    </td>
                </tr>
                <% }%>
            </table>
